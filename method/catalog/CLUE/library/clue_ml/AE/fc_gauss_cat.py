...
import logging
from method.catalog.CLUE.library.clue_ml.AE.models import MLP_preact_generator_net, MLP_preact_recognition_net
from method.catalog.CLUE.library.clue_ml.src.gauss_cat import flat_to_gauss_cat, gauss_cat_to_flat, rms_cat_loglike, selective_softmax
from method.catalog.CLUE.library.clue_ml.src.probability import normal_parse_params
from method.catalog.CLUE.library.clue_ml.src.radam import RAdam
from method.catalog.CLUE.library.clue_ml.src.utils import BaseNet, to_variable
...
class VAE_gauss_cat_net(BaseNet):
    ...
    def create_net(self):
        ...
        logging.info("Total params: %.2fM" % (self.get_nb_parameters() / 1000000.0))
