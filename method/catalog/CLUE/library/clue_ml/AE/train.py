...
from method.catalog.CLUE.library.clue_ml.src.utils import humansize, torch_onehot
...
def train_VAE(
    ...
    logging.info("init cost variables:")
    ...
    for i in range(epoch, nb_epochs):
        ...
        # ---- print
        logging.info("it %d/%d, vlb %f, " % (i, nb_epochs, vlb_train[i]))
        logging.info("time: %f seconds\n" % (toc - tic))
        net.update_lr(i)
    ...
    logging.info("average time: %f seconds\n" % runtime_per_it)
    ...
    logging.info("best_vlb_dev: %f" % best_cost_dev)
    logging.info("best_vlb_train: %f" % best_cost_train)
    logging.info("nb_parameters: %d (%s)\n" % (nb_parameters, humansize(nb_parameters)))
